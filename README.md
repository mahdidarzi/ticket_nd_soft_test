...
Service Layer: Contains core business logic, abstracted via Interfaces (Dependency Inversion).
Repository Layer: Manages data persistence using Spring Data JPA.
Mapper Layer: Decouples Entities from DTOs (Single Responsibility Principle).
AOP Layer: Intercepts service calls for non-functional requirements like logging and performance monitoring.
SOLID Principles Applied:
Single Responsibility: Separated concerns between Controllers, Services, Mappers, and Entities.
